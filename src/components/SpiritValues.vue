...
<fieldset class="spiritValuesContainer">
      ...
      <!-- <input type="text" :id="`spirit-${index}`" :value="name" /> -->
      <label :for="`total-drink-abv-${index}`" class="w-full flex flex-col my-4">{{ name }} ABV in %</label>
