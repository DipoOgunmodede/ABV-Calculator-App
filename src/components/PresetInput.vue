<template>
    ...
    <div class="flex justify-center"><button class="px-4 py-2 hover:border-tertiary hover:text-white rounded border-2 border-quaternary text-tertiary" @click.prevent="emitSelectedPresetIndex(index)">Add {{ calculateMeasure }}</button></div>
</template>
<script>
export default {
    props: {
