<template>
    ...
    <div class="flex justify-center"><button class="px-4 py-2 hover:bg-green-500 hover:text-white rounded border-2 border-secondary" @click.prevent="emitSelectedPresetIndex(index)">Add {{ calculateMeasure }}</button></div>
</template>
<script>
export default {
    props: {
